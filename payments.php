		...
		<form method="post" id="payfeeForm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-plus"></i> Edit Payment</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="admissionNumber" class="control-label">Admission Number*</label>
						<input type="text" class="form-control" id="admissionNumber" name="admissionNumber" placeholder="Class Name" required>					
					</div>	
					<div class="form-group">
					...
					<div class="form-group">
						<label for="ammount" class="control-label">Ammount paid*</label>	
